...
<body >
	...
	<div class="form">
		<form method="POST" action="admin_signup.php">
			...
			<p class="form-p1">Admin Registration Form</p>
			...
			<input type="text" class="txt2" name="firstname" value="<?php echo $firstname; ?>"placeholder="first name"> 
			<input type="text" class="txt3" name="lastname" value="<?php echo $lastname; ?>"placeholder="last name"><br><br><br><br>
			...
			<input type="Number" class="txt8" name="number" value="<?php echo $number; ?>"placeholder="+00000000000"><br><br><br>
			...
			<center>
				...
				<a href="admin_login.php"><input type="button" Class="Submitbtn" value="LOGIN"></a>
			</center>
